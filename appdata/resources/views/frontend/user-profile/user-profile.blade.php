...
<div class="row">
	<div class="col-md-8 offset-md-2 mt-3">
		<div class="alert alert-success alert-dismissible">
			<a href="{{url('user-profile?')}}" class="close">&times;</a>
			<strong>Success!</strong>Your post has been {{@$s_msg}} Successfully!
		</div>	
	</div>
</div>
@endif
...
@section('script')
<script>
	window.update_ads_validity ='<?= url('update-ads-validity')?>'
	window.this_payment_info = '<?= url('get-this-payment-info')?>'
