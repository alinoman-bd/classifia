 	...
 	<div class="row mar-0">
 		<div class="col-12 col-lg-8 pad-l-0">
 			<div class="g-v d-none">
 				...
 				<a href="{{ asset('/ServicesImages/'.$value->image) }}" data-g-itm='{{$key}}' data-fancybox="gallery">
 					<div class="content-img">
 						<img src="{{ asset('/ServicesImages/'.$value->image) }}" alt="img">
 					</div>
 				</a>
 				@endforeach
 			</div>
 					...
 					<div class="swiper-wrapper">
 						...
 						<div class="swiper-slide">
 							<div class="slider-img hw-100">
 								<img class="cover" src="{{ asset('/ServicesImages/'.$value->image) }}" alt="product">
 							</div>
 						</div>
 						@endforeach
 					</div>
 ...
 <section class="realestate-price-d">
 	<div class="price-d">
 		...
 		<div class="realestate-d-list">
 			<div class="row mar-0">
 				<div class="col-12 col-md-7 col-lg-5 pad-l-0">
 					<div class="realestate-d-cnt cnt-after">
 						<table class="table">
 							<tbody>
 								...
 								@endif
 								@if($advertisement->web_url)
 								<tr>
 									<th>Url:</th>
 									<td>{{$advertisement->web_url}}</td>
 								</tr>
 								@endif
 							</tbody>
 						</table>
