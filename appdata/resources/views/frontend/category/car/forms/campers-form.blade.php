		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="campare_type" name="campare_type" class="required" />
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			...
			<div class="col-sm-6 col-md-4 col-lg-3">
				<div class="form-group">
					...
					<input type="text" name="bed_num" id="bed_num" class="form-control required" min="1">
				</div>
			</div>
			<div class="col-sm-6 col-md-4 col-lg-3">
				<div class="form-group">
			...
			<div class="col-sm-6 col-md-4 col-lg-3">
				<div class="form-group">
					...
					<input type="number" id="water_tank_capacity" name="water_tank_capacity" class="form-control" min="1">
				</div>
			</div>
			...
			<div class="col-sm-6 col-md-4 col-lg-3">
				<div class="form-group">
					...
					<input type="number" id="septic_tank" name="septic_tank" class="form-control">
				</div>
			</div>
			<div class="col-sm-6 col-md-4 col-lg-3 pad-0">
				<div class="row mar-0">
