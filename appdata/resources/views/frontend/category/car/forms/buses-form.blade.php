	...
	<div class="row mar-0">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="bus_type" name="bus_type" class="required" />
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="gross_weight" name="gross_weight" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress"> Kerb weight, kg </label>
				<input type="number" class="form-control" min="1" id="kerb_weight" name="kerb_weight" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="doors_number" name="doors_number" class="" />
					<div class="ctm-option-box">
