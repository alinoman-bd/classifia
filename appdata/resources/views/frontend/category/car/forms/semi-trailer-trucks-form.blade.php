		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="sleep_bed" name="sleep_bed" class="required" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="front_suspension" name="front_suspension" class="required" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="rear_suspension" name="rear_suspension" class="required" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="euro_stndard" name="euro_stndard" class="required"/>
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="layout" name="layout" class="required" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="str_wheel" name="str_wheel" class="" />
					<div class="ctm-option-box">
			...
			<div class="row mar-0">
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<div class="ctm-select">
							...
							<input type="hidden" id="semi_trailer_type" name="semi_trailer_type" class="" />
							<div class="ctm-option-box">
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<div class="ctm-select">
							...
							<input type="hidden" id="semi_trailer_manufacturer" name="semi_trailer_manufacturer" class="" />
							<div class="ctm-option-box">
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<input type="number" id="semi_trailer_model" name="semi_trailer_model" class="form-control">
					</div>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<div class="ctm-select">
							...
							<input type="hidden" id="semi_trailer_suspension" name="semi_trailer_suspension" class="" />
							<div class="ctm-option-box">
						...
						<div class="col-md-8">
							<div class="form-group">
								<div class="ctm-select">
									...
									<input type="hidden" id="semi_manufature_year" name="manufature_year" class="w-75 float-left" />
									<input type="hidden" id="semi_manufature_month" name="semi_manufature_month" class="w-25 float-left" />
									<div class="ctm-option-box">
										<?php 
										$startyear = 1901;
										$now = Carbon\Carbon::now();
						...
						<div class="col-md-8">
							<div class="form-group">
								<div class="ctm-select">
									...
									<input type="hidden" id="semi_mot_exp_date" name="semi_mot_exp_date" class="float-left w-50"/>
									<div class="ctm-option-box">
						...
						<div class="col-md-4">
							<div class="form-group">
								<div class="ctm-select">
									...
									<input type="hidden" id="semi_mot_exp_mnth" name="semi_mot_exp_mnth" class="float-left w-25"/>
									<div class="ctm-option-box">
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<input type="number" id="semi_gross_weight" name="semi_gross_weight" class="form-control" min="1">
					</div>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						<label for="inputAddress"> Semi-tr. kerb weight, kg  </label>
						<input type="number" id="semi_kerb_weight" name="semi_kerb_weight" class="form-control" min="1">
					</div>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						<label for="inputAddress"> Semi-trailer length, mm</label>
						<input type="number" id="semi_length" name="semi_length" class="form-control" min="1">
					</div>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						<label for="inputAddress"> Semi-trailer width, mm</label>
						<input type="number" id="semi_width" name="semi_width" class="form-control" min="1">
					</div>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						<label for="inputAddress"> Semi-trailer height, mm</label>
						<input type="number" id="semi_height" name="semi_height" class="form-control" min="1">
					</div>
				</div>
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						<label for="inputAddress"> Semi-trailer capacity, m³</label>
						<input type="number" id="semi_capacity" name="semi_capacity" class="form-control" min="1">
					</div>
				</div>	
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<div class="ctm-select">
							...
							<input type="hidden" id="alx_make" name="alx_make" class="" />
							<div class="ctm-option-box">
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<div class="ctm-select">
							...
							<input type="hidden" id="semi_axl_num" name="semi_axl_num" class="" />
							<div class="ctm-option-box">
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<div class="ctm-select">
							...
							<input type="hidden" id="semi_damage" name="semi_damage" class="" />
							<div class="ctm-option-box">
								@foreach(App\UsedCarDamage::all() as $damage)
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<div class="ctm-select">
							...
							<input type="hidden" id="semi_color" name="semi_color" class="" />
							<div class="ctm-option-box">
								@foreach(App\UsedCarColor::all() as $color)
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<div class="ctm-select">
							...
							<input type="hidden" id="semi_new_used" name="semi_new_used" class="" />
							<div class="ctm-option-box">
				...
				<div class="col-sm-6 col-md-4 col-lg-3">
					<div class="form-group">
						...
						<input type="number" id="semi_vin_num" name="semi_vin_num" class="form-control">
					</div>
				</div>
			</div>
		</div>
