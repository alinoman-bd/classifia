 ...
 <form id="formForm" method="post"  class="formForServicesAdUpdate" enctype="multipart/form-data">
 	@csrf
 	...
 	<div class="row m-0">
 		...
 		<div class="col-12 col-md-8" style="margin-top: 30px;">
 			...
 			<div class="form-group">
 				...
 				<input type="text" value="{{$post->web_url}}"  class="form-control controls" placeholder="website url" name="web_url">
 			</div>
 		</div>
 			...
 			<div class="additional-info extra-info1 add-photo" >
 				<div class="row mar-0">
 					...
 					<div class="col-12 col-md-6" style="position: relative;">
 						...
 						@if($img->type !== 'cover')
 						<span class="pip">
 							<img class="imageThumb" src="{{asset('ServicesImages/'. $img->image)}}" title=""/>
...
<script>
	...
	window.update_services_form = '<?= url('update-services-form')?>'
