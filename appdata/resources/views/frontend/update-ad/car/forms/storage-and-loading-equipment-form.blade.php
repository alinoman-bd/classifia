	...
	<div class="row mar-0">
			...
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->storage_type? $post->storage_type : '-'?></span>
					...
					<input type="hidden" id="storage_type" name="storage_type" value="{{$post->storage_type}}" class="required" />
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="vat" name="vat" value="{{$post->make}}" class="" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->boom_type? $post->boom_type : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<input type="hidden" id="boom_type" name="boom_type" value="{{$post->boom_type}}" class="required" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" name="lifting_height" id="lifting_height" value="{{$post->lifting_height}}" class="form-control">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="struc_height" name="struc_height" value="{{$post->struc_height}}" class="form-control">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress">  Free lifting height, mm</label>
				<input type="number" id="fr_lift_height" name="fr_lift_height" value="{{$post->fr_lift_height}}" class="form-control">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="fork_length" name="fork_length" value="{{$post->fork_length}}" class="form-control">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress">   Lifting capacity, kg</label>
				<input type="number" id="lift_capacity" name="lift_capacity" value="{{$post->lift_capacity}}"  class="form-control">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-6">
			...
			<div class="row">
				<div class="col-lg-4">
					<input placeholder="Length" id="length" name="length" value="{{$post->length}}" type="number" min="1" class="form-control">
				</div>
				<div class="col-lg-4">
					<input placeholder="Height" type="number" min="1" id="height" value="{{$post->height}}" name="height" class="form-control">
				</div>
				<div class="col-lg-4">
					<input placeholder="Width" type="number" min="1" id="width" value="{{$post->width}}" name="width" class="form-control">
				</div>
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
