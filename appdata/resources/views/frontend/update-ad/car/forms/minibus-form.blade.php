	...
	<div class="row mar-0">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->minivan_type? $post->minivan_type : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<label for="minivan_type"><span class="asterisk text-danger">This field is required</span></label>
					<input type="hidden" id="minivan_type" name="minivan_type" value="{{$post->minivan_type}}" class="required" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="seat_number" name="seat_number" value="{{$post->seat_number}}" class="required form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="newUsed" name="new_used" value="{{$post->new_used}}" class="" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->minibus_length? $post->minibus_length : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<input type="hidden" id="minibus_length" name="minibus_length" value="{{$post->minibus_length}}" class="" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->minibus_height? $post->minibus_height : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<input type="hidden" id="minibus_height" name="minibus_height" value="{{$post->minibus_height}}" class="" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="climate_contrl" name="climate_contrl" value="{{$post->climate_contrl}}" class=""/>
					<div class="ctm-option-box">
