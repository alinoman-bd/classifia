	...
	<div class="row mar-0">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="eng_type" name="eng_type" value="{{$post->eng_type}}" class="required" />
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="text" id="eng_make" name="eng_make" value="{{$post->eng_make}}" class="form-control required" >
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="text" id="eng_model" name="eng_model" value="{{$post->eng_model}}" class="form-control required">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="eng_capacity" name="eng_capacity" value="{{$post->eng_capacity}}" class="form-control required">
			</div>
		</div>
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="text" id="cylinder_num" name="cylinder_num" value="{{$post->cylinder_num}}" class="form-control">
			</div>
		</div>		
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress">Max. revolutions per min. (RPM)</label>
				<input type="text" id="revolution" name="revolution" value="{{$post->revolution}}"  class="form-control">
			</div>
		</div>		
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->start_system? $post->start_system : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<input type="hidden" id="start_system" name="start_system" value="{{$post->start_system}}" class="" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->leg_size? $post->leg_size : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<input type="hidden" id="leg_size" name="leg_size" value="{{$post->leg_size}}" class="" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="text" id="fuel_tank_capacity" value="{{$post->fuel_tank_capacity}}" name="fuel_tank_capacity" class="form-control">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress"> Weight, kg</label>
				<input type="text" id="weight" name="weight" value="{{$post->weight}}" class="form-control">
			</div>
		</div>
	</div>
</div>
