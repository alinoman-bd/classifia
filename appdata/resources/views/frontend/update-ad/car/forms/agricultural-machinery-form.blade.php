	...
	<div class="row mar-0">
			...
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->agri_mach_type? $post->agri_mach_type : '-'?></span>
					...
					<input type="hidden" id="agri_mach_type" value="{{$post->agri_mach_type}}" name="agri_mach_type" class="required" />
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" name="ope_width" value="{{$post->ope_width}}" id="ope_width" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="make" value="{{$post->make}}" name="make" class="required" />	
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" name="work_hour" value="{{$post->work_hour}}" id="work_hour" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="row mar-0">
				...
				<div class="col-md-8">
					<div class="form-group">
						<input type="number" name="power" value="{{$post->power}}" id="power" min="1" class="form-control">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" name="export_price" value="{{$post->export_price}}" id="export_price" class="form-control">
			</div>
		</div>
	</div>
</div>
