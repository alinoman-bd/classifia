			...
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->bus_type? $post->bus_type : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<label for="bus_type"><span class="asterisk text-danger">This field is required</span></label>
					<input type="hidden" id="bus_type" name="bus_type" value="{{$post->bus_type}}" class="required" />
					<div class="ctm-option-box">
						@foreach(App\BusesType::all() as $bus_type)
						<div class="ctm-option" onclick="setThis('bus_type','<?= $bus_type->type_name?>')">{{$bus_type->type_name}}</div>
						@endforeach
					</div>
				</div>
			</div>
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="damage" name="damage" value="{{$post->madamageke}}" class="required" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="doors_number" value="{{$post->doors_number}}" name="doors_number" class="" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="input-group">
					<input type="text" class="form-control" value="{{$post->make}}" placeholder="00" id="vin_num" name="vin_num">
				</div>
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->vin_num? $post->vin_num : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<input type="hidden" id="euro_stndard" value="{{$post->vin_num}}" name="euro_stndard" class=""/>
					<div class="ctm-option-box">
	...
	<div class="row mar-0">
		...
		<div class="col-12 pad-0 extra-box">
			...
			<div class="row mar-0">
				...
				<?php $n++; ?>
				@foreach(App\BusesFeatureEqpmentValue::all() as $value)
