	...
	<div class="row mar-0">
			...
			<div class="form-group">
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->watercraft_manufacturer? $post->watercraft_manufacturer : '-'?></span>
					...
					<input type="hidden" id="watercraft_manufacturer" value="{{$post->watercraft_manufacturer}}" name="watercraft_manufacturer" class="required" />
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="weight_capacity" name="weight_capacity" value="{{$post->weight_capacity}}"  class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="row mar-0">
				...
				<div class="col-md-8">
					<div class="form-group">
						<input type="number" name="power" id="power" value="{{$post->make}}" class="form-control" min="1">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
						<div class="ctm-select">
							...
							<input type="hidden" id="power_unit" name="power_unit" value="{{$post->make}}" />
							<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" name="fuel_tank_capacity" value="{{$post->fuel_tank_capacity}}" id="fuel_tank_capacity" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="cylinder_num" name="cylinder_num" value="{{$post->cylinder_num}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="storage_capacity" name="storage_capacity" value="{{$post->storage_capacity}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
