	...
	<div class="row mar-0">
			...
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->boat_raft_type? $post->boat_raft_type : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<label for="boat_raft_type"><span class="asterisk text-danger">This field is required</span></label>
					<input type="hidden" id="boat_raft_type" value="{{$post->boat_raft_type}}" name="boat_raft_type" class="required" />
					<div class="ctm-option-box">
						@foreach(App\BoatsRaftsType::all() as $type)
						<div class="ctm-option" onclick="setThis('boat_raft_type', '<?= $type->type_name?>')">{{$type->type_name}}</div>
						@endforeach
					</div>
				</div>
			</div>
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" name="seat_num" id="seat_num" value="{{$post->seat_num}}" class="form-control required" min="1">
			</div>
		</div>	
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="overall_length" name="overall_length" value="{{$post->overall_length}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress">  Width overall, m </label>
				<input type="number" id="overall_width" name="overall_width" value="{{$post->overall_width}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress"> Inner length, m</label>
				<input type="number" id="inner_length" name="inner_length" value="{{$post->inner_length}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress">  Inner width, m</label>
				<input type="number" id="inner_width" name="inner_width" value="{{$post->inner_width}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
	...
	<div class="row mar-0">
		...
		<div class="col-12 pad-0 extra-box">
			<div class="row mar-0">
				...
				@foreach(App\BoatsRaftsFeatureEqValue::all() as $value)
				<div class="col-sm-6 col-md-4 col-lg-3">
...
<script>
	...
	function setThis(filed,item){
			// alert(filed);
			if(filed == 'boat_raft_type'){
				$("#boat_raft_type").val(item);
