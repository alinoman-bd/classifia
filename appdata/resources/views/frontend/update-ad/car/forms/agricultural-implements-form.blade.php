	...
	<div class="row mar-0">
			...
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->agri_imp_type? $post->agri_imp_type : '-'?></span>
					...
					<input type="hidden" id="agri_imp_type" value="{{$post->agri_imp_type}}" name="agri_imp_type" class="required" />	
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" name="ope_width" id="ope_width" value="{{$post->ope_width}}" class="form-control required" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" name="frames" value="{{$post->frames}}" id="frames" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="input-group">
					...
					<input type="text" class="form-control search-i required" placeholder="5000" name="price" value="{{$post->price}}" id="price">
				</div>
			</div>
		</div>
