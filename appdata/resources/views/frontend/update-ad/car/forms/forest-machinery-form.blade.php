	...
	<div class="row mar-0">
			...
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->forest_mach_type? $post->forest_mach_type : '-'?></span>
					...
					<input type="hidden" id="forest_mach_type" value="{{$post->forest_mach_type}}" name="forest_mach_type" class="required" />
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="row mar-0">
				...
				<div class="col-md-8">
					<div class="form-group">
						<input type="number" name="power" id="power" value="{{$post->power}}" min="1" class="form-control">
					</div>
				</div>
				<div class="col-md-4">
					<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" name="wheel_width" id="wheel_width" value="{{$post->wheel_width}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress"> Range, mm </label>
				<input type="number" name="range" id="range" value="{{$post->range}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress"> Lifting moment, kNm </label>
				<input type="number" name="lifting_moment" value="{{$post->lifting_moment}}" id="lifting_moment" class="form-control" min="1">
			</div>
		</div>
	</div>
</div>
