			...
			<div class="form-group">
				...
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->truck_type? $post->truck_type : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<label for="truck_type"><span class="asterisk text-danger">This field is required</span></label>
					<input type="hidden" id="truck_type" name="truck_type" value="{{$post->truck_type}}" class="required" />
					<div class="ctm-option-box">
						@foreach(App\TruckType::all() as $type)
						<div class="ctm-option" onclick="setThis('truck_type','<?= $type->type_name?>')">{{$type->type_name}}</div>
						@endforeach
					</div>
				</div>
			</div>
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="sleep_bed" name="sleep_bed" value="{{$post->sleep_bed}}" class="" />
					<div class="ctm-option-box">
