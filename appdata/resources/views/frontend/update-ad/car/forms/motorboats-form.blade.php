	...
	<div class="row mar-0">
			...
			<div class="form-group">
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->motorboat_type? $post->motorboat_type : '-'?></span>
					...
					<input type="hidden" id="motorboat_type" value="{{$post->motorboat_type}}" name="motorboat_type" class="required" />
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			...
			<div class="form-group">
				<div class="ctm-select">
					<div class="ctm-select-txt pad-l-10">
						<span class="select-txt" id="category"><?= $post->boat_purpose? $post->boat_purpose : '-'?></span>
						<span class="select-arr"><img src="{{ asset('assets/img/down-ar.png') }}" alt="lt flag"></span>
					</div>
					<label for="boat_purpose"><span class="asterisk text-danger">This field is required</span></label>
					<input type="hidden" id="boat_purpose" name="boat_purpose" value="{{$post->boat_purpose}}" class="required" />
					<div class="ctm-option-box">	
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="text" id="manufacturer" name="manufacturer" value="{{$post->manufacturer}}" class="form-control required">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<label for="manufacturer"><span class="asterisk text-danger reqired-wth-custom-css">This field is required</span></label>
				<input type="text" id="model" name="model" value="{{$post->model}}" class="form-control required">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<label for="price"><span class="asterisk text-danger reqired-wth-custom-css">This field is required</span></label>
				<input type="number" id="overall_length" value="{{$post->overall_length}}" name="overall_length" class="form-control required" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress">  Draft, m </label>
				<input type="number" id="draft" name="draft" value="{{$post->draft}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				<label for="inputAddress"> Beam </label>
				<input type="number" id="beam" name="beam" value="{{$post->beam}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="frsh_water_capacity" name="frsh_water_capacity" value="{{$post->frsh_water_capacity}}" class="form-control" min="1">
			</div>
		</div>	
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="passenger_num" name="passenger_num" value="{{$post->passenger_num}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="tiolet_num" name="tiolet_num" value="{{$post->tiolet_num}}" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<div class="ctm-select">
					...
					<input type="hidden" id="batterie_type" value="{{$post->batterie_type}}" name="batterie_type" />
					<div class="ctm-option-box">
		...
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
				...
				<input type="number" id="batterie_capacity" value="{{$post->batterie_capacity}}" name="batterie_capacity" class="form-control" min="1">
			</div>
		</div>
		<div class="col-sm-6 col-md-4 col-lg-3">
			<div class="form-group">
