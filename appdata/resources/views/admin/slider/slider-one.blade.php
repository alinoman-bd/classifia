	...
	<div class="page-breadcrumb border-bottom">
		<div class="row">
			<div class="col-lg-12 col-md-12 col-xs-12 align-self-center">
				<h5 class="font-medium text-uppercase mb-0">Slider One <small>will appear in top section of home and all the categories browsing page according to slider type</small></h5> 
			</div>
			...
			<div class="modal-body">
				<form method="post" id="storeSlider" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						<select name="slider_type" required="" class="form-control" name="url">
							<option value=""></option>
							...
							<option value="buy-sale">Buy/Sale</option>
						</select> 
					</div>
					<div class="form-group">
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" id="updateSlider" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label for="">Select Type</label>
						<select name="slider_type" id="sliderType" required="" class="form-control" name="url">
							<option value=""></option>
							<option value="home_page">Home Page</option>
							<option value="house">House</option>
							<option value="job">Job</option>
