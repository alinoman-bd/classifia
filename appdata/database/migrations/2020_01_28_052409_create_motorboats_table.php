...
class CreateMotorboatsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('motorboats', function (Blueprint $table) {
            $table->string('motorboat_type');
            $table->string('boat_purpose');
            ...
            $table->string('frsh_water_capacity');
            $table->string('hold_tank_capacity');
            $table->string('passenger_num');
    ...
    {
        Schema::dropIfExists('motorboats');
    }
}
